...
- `docs/issue-<n>/reports/qa/regress/` has tests → always run the
  ...
  other failure.
- `docs/issue-<n>/reports/qa/plan.md` exists → execute its cases,
...
- evidence: command + output, screenshot path, or log excerpt — stored under
  `docs/issue-<n>/reports/qa/evidence/<run-slug>/`
...
`docs/issue-<n>/reports/qa/`.

## 5. Record

Write `docs/issue-<n>/reports/qa/runs/<YYYY-MM-DD>-<slug>.md`:

```markdown
# Run <date> — <scope>

profile: docs/issue-<n>/reports/qa/intake.md (or "none")
