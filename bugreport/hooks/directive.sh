...
- The project's own issue template, labels, and language (per qa/intake.md) win over the stack's standard form. The standard form is only the fallback for projects that have none.
